...
WHERE
    ...
    (
        ...
        -- ADM 5
        (l.feature_code_id = 119 AND ac.admin1_code = '13' AND ac.admin2_code = '00' AND ac.admin3_code = '14612' AND ac.admin4_code = '14612000')
...
SELECT
    ...
    CASE
        WHEN l.feature_code_id = 175 AND ac.admin1_code = '00' AND ac.admin2_code IS NULL AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL THEN 1
        WHEN l.feature_code_id = 107 AND ac.admin1_code = '52' AND ac.admin2_code IS NULL AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL THEN 2
        WHEN l.feature_code_id = 104 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL THEN 3
        WHEN l.feature_code_id = 11 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL THEN 4
        WHEN l.feature_code_id = 68 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL THEN 5
        WHEN l.feature_code_id = 119 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL THEN 6
        ELSE 7
    END AS order_column
FROM
    admin_code ac
...
WHERE
    ...
    (
        ...
        -- ADM 1
        (l.feature_code_id = 107 AND ac.admin1_code = '52' AND ac.admin2_code IS NULL AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL) OR

        -- ADM 2
        (l.feature_code_id = 104 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL) OR

        -- ADM 3
        (l.feature_code_id = 11 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL) OR

        -- ADM 4
        (l.feature_code_id = 68 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL) OR

        -- ADM 5
        (l.feature_code_id = 119 AND ac.admin1_code = '52' AND ac.admin2_code = '8378776' AND ac.admin3_code = '500208' AND ac.admin4_code IS NULL)
...
WHERE
    l.country_id = 1 AND
    ST_Distance(l.coordinate, ST_SetSRID(ST_MakePoint(13.73832, 51.05089), 4326)) <= 10000 AND
    (
        -- country
        (l.feature_code_id = 175 AND ac.admin1_code = '00' AND ac.admin2_code IS NULL AND ac.admin3_code IS NULL AND ac.admin4_code IS NULL) OR
        ...
        (l.feature_code_id = 11 AND ac.admin1_code = '13' AND ac.admin2_code = '00' AND ac.admin3_code = '14612' AND ac.admin4_code IS NULL) OR
        (l.feature_code_id = 68 AND ac.admin1_code = '13' AND ac.admin2_code = '00' AND ac.admin3_code = '14612' AND ac.admin4_code = '14612000') OR
        (l.feature_code_id = 119 AND ac.admin1_code = '13' AND ac.admin2_code = '00' AND ac.admin3_code = '14612' AND ac.admin4_code = '14612000') OR
        ...
        (l.feature_code_id IN (14, 2) AND ac.admin1_code = '13' AND ac.admin2_code = '00' AND ac.admin3_code = '14612' AND ac.admin4_code = '14612000')
